...
export default function ClockingRecordList({
  clockingRecordList,
  clockingMachineList,
  employeeList,
}) {
  ...
  const [listData, setListData] = useState(clockingRecordList)
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      <h4 className="m-0">Clocking Record</h4>
  ...
  // Table Template
  const clockingDatetimeBodyTemplate = (rowData) => {
    return (
      <span className="font-bold">
        {new Date(rowData.clocking_record_datetime).toLocaleString()}
      </span>
    )
  }
  ...
  const isEditBodyTemplate = (rowData) => {
    return (
      <Tag severity={getSeverity(rowData.clocking_record_is_edit_hm)}>
        {rowData.clocking_record_is_edit_hm}
      </Tag>
    )
  }
      ...
      <div className="card">
        ...
        <DataTable
          ...
          <Column
            ...
            body={clockingDatetimeBodyTemplate}
            style={{ minWidth: '4rem' }}></Column>
          <Column
          ...
          <Column
            header="Is Edit"
            field="clocking_record_is_edit"
            body={isEditBodyTemplate}
            style={{ minWidth: '5rem' }}></Column>
          <Column
            header="CreateTime"
            sortable
        ...
        <Paginator
          ...
          currentPageReportTemplate={
            'Showing {first} to {last} of {totalRecords} clocking record'
          }></Paginator>
      </div>
